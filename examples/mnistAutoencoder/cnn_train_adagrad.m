...
for epoch=1:opts.numEpochs
  ...
  switch opts.errorType
    case 'multiclass'
      ...
      plot([1 opts.snapshot : opts.test_interval : epoch epoch], info.val.error([1 opts.test_interval : opts.test_interval : epoch epoch]), 'b') ;
      plot([1 opts.snapshot : opts.test_interval : epoch epoch], info.val.topFiveError([1 opts.test_interval : opts.test_interval : epoch epoch]), 'b--') ;
